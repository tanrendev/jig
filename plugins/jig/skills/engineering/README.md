...
Run `/jig:setup` once per repo first: it configures the issue tracker, triage labels, and domain doc layout the tracker-backed skills (`triage`, `to-spec`, `to-tickets`, `code-review`, `wayfinder`) assume.
